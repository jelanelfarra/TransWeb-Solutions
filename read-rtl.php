...
<body class="Ar">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="main-nav">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link hvr-pop" href="read-rtl.php">عن الشركة</a>
                    </li>
         ...
         <a class="nav-link dropdown-toggle hvr-pop" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          خدماتنا
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item">
                        <a class="nav-link hvr-pop" href="contact-rtl.php">تواصل معنا <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" href="read-rtl.php">العربية</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="read.php">الانجليزية</a>
        </div>
      </li>
        </div>
    </nav>
    <!------------Who Are TransWeb--------------------->
    <section class="read text-center">
    
    <h2 class="head-after-read Ar wow fadeInDown" data-wow-duration="2s">من نحن ؟ </h2>
     <p class="read-more Ar">
     ترانزويب هي شركة مختارة من قبل العديد من العملاء في نطاق خدمات الترجمة وتطوير مواقع الويب.<br>
      <br>  نقدم جميع الخدمات المتعلقة بالترجمة حيث تشمل خدماتنا على ترجمة الوثائق والمقالات العلمية والتدقيق اللغوي وترجمة مواقع الويب وخدمات التفريغ السمعي والتعليق الصوتي وكتابة المحتوى والكتابة على الفيديو.<br><br>
        في مجال تطوير الويب ، نقدم مجموعة واسعة من حلول الويب المخصصة للشركات الصغيرة والكبيرة في مجالات مختلفة. من خلال أقصى جهد واهتمام بالتفاصيل ، 
        نقوم بإنشاء تطبيقات الويب والخدمات والمواقع التي تلبي بدقة توقعاتك وتلبية الاحتياجات الخاصة لشركتك. يتمتع فريق العمل لدينا بمهارات عالية ، ويوفر جودة ممتازة مثالية وخدمات مخصصة وموجهة للعملاء في جوانب تطوير الويب (الواجهة الأمامية والخلفية ).
     </p>

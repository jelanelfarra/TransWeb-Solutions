...
<body class="En">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="lang-rtl.php">Arabic</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item active" href="lang.php">English</a>
        </div>
      </li>
         ...
         <a class="nav-link dropdown-toggle hvr-pop" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          SERVICES
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="lang.php">Translation</a>
                </div>
                </li>
                    <li class="nav-item">
    ...
    <!------------Available Langauges--------------------->
    <section class="lang text-center">
    <h2 class="head-after-lang wow fadeInDown" data-wow-duration="2s">The features we offer!</h2>
        <p>
        There are many translation companies around the world, each of them providing services in each discipline separately, but Transweb makes the difference, it combines all the services provided by companies and other agencies each separately, it provides all services related to translation as it includes our translation services Translation of scientific documents and articles, proofreading, website translation, desktop publishing of translated materials and translation projects for more than 1000 languages ​​In addition, we also provide audio discharge services, voice commentary, simultaneous translation, content writing and spital.

        </p>
    <div class="container">
            <h2 class="head-after wow fadeInDown" data-wow-duration="2s">Available languages</h2>
         <div class="row">
         <div class="col-md-3 col-lg">
            <ul class="lang-sec text-left">
            <li>Arabic</li>
            <li>Bengali</li>
            <li>Bulgarian</li>
            <li>Burmese</li>
